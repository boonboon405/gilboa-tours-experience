...
const categoryKeywords: Record<DNACategory, string[]> = {
  adventure: ['הרפתקא', 'אתגר', 'אדרנלין', 'ג\'יפ', 'רפלינג', 'זיפליין', 'קטגר', 'פיינטבול', 'קיאק'],
  ...
  teambuilding: ['בניית צוות', 'גיבוש', 'מנהיגות', 'תקשורת', 'שיתוף פעולה', 'ליווי ארגוני', 'יום צוות', 'קבוצה', 'דיון']
};
