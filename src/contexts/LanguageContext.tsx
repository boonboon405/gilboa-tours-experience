...
const translations = {
  ...
  he: {
    ...
    'activities.history.desc': 'ביקור בכתף שאול, צפייה באירוס הגלבוע, ושקנאים מרהיבים בנדידה מעל עמק הירדן.',
    ...
    'activities.culinary.desc': 'ארוחה עשירה במסעדה כשרה עם אוכל מזרחי אותנטי - טעם אמיתי של האזור.',
    ...
    'why.custom.desc': 'מעוצב במיוחד לקבוצות עסקיות ומקצועיות',
