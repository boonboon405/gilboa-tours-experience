...
const locations: Location[] = [
  ...
  { key: 'golan-heights', nameHe: 'רמת הגולן', nameEn: 'Golan Heights', descriptionHe: 'נופי בזלת וולקנים מרהיבים', descriptionEn: 'Stunning volcanic basalt landscapes', imageUrl: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=600&q=80&fit=crop' },
  ...
  { key: 'rosh-hanikra', nameHe: 'ראש הנקרה', nameEn: 'Rosh Hanikra', descriptionHe: 'מערות הגיר הלבנות על הים', descriptionEn: 'White chalk cliff sea caves', imageUrl: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600&q=80&fit=crop' },
  { key: 'acre-walls', nameHe: 'חומות עכו', nameEn: 'Acre Walls', descriptionHe: 'עיר נמל עתיקה ומבוצרת', descriptionEn: 'Ancient fortified port city', imageUrl: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=600&q=80&fit=crop' },
  ...
  { key: 'mount-arbel', nameHe: 'הר ארבל', nameEn: 'Mount Arbel', descriptionHe: 'מצוקים דרמטיים מעל הכנרת', descriptionEn: 'Dramatic cliffs over the Galilee', imageUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80&fit=crop' },
  { key: 'tiberias-promenade', nameHe: 'טיילת טבריה', nameEn: 'Tiberias Promenade', descriptionHe: 'טיילת ציורית לחוף הכנרת', descriptionEn: 'Scenic waterfront promenade', imageUrl: 'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=600&q=80&fit=crop' },
  { key: 'nazareth-hills', nameHe: 'הרי נצרת', nameEn: 'Nazareth Hills', descriptionHe: 'נופי הגליל הירוקים', descriptionEn: 'Green Galilee landscapes', imageUrl: 'https://images.unsplash.com/photo-1517760444937-f6397edcbbcd?w=600&q=80&fit=crop' },
  { key: 'beit-shean', nameHe: 'בית שאן', nameEn: 'Beit She\'an', descriptionHe: 'התיאטרון הרומי העתיק', descriptionEn: 'Ancient Roman theater', imageUrl: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=600&q=80&fit=crop' },
  { key: 'mount-gilboa', nameHe: 'הר הגלבוע', nameEn: 'Mount Gilboa', descriptionHe: 'שדות האירוסים הסגולים', descriptionEn: 'Purple iris flower fields', imageUrl: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=600&q=80&fit=crop' },
  { key: 'haifa-bay', nameHe: 'מפרץ חיפה', nameEn: 'Haifa Bay', descriptionHe: 'מפרץ ים תיכוני יפהפה', descriptionEn: 'Beautiful Mediterranean bay', imageUrl: 'https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?w=600&q=80&fit=crop' },
  ...
  { key: 'nimrod-fortress', nameHe: 'מבצר נמרוד', nameEn: 'Nimrod Fortress', descriptionHe: 'טירה מימי הביניים', descriptionEn: 'Medieval castle ruins', imageUrl: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=80&fit=crop' },
  ...
  { key: 'capernaum', nameHe: 'כפר נחום', nameEn: 'Capernaum', descriptionHe: 'בית כנסת עתיק לחוף הכנרת', descriptionEn: 'Ancient lakeside synagogue', imageUrl: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=600&q=80&fit=crop' },
  ...
  { key: 'korazim', nameHe: 'כורזים', nameEn: 'Korazim', descriptionHe: 'חורבות בזלת שחורות', descriptionEn: 'Black basalt ruins', imageUrl: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=80&fit=crop' },
  ...
  { key: 'bahai-gardens', nameHe: 'גני הבהאי', nameEn: 'Bahai Gardens', descriptionHe: 'גנים מדורגים מרהיבים בחיפה', descriptionEn: 'Stunning terraced gardens in Haifa', imageUrl: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600&q=80&fit=crop' },
  { key: 'caesarea-aqueduct', nameHe: 'אמת המים קיסריה', nameEn: 'Caesarea Aqueduct', descriptionHe: 'שרידי אמת מים רומית על החוף', descriptionEn: 'Roman aqueduct ruins on beach', imageUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&q=80&fit=crop' },
  { key: 'zippori', nameHe: 'ציפורי', nameEn: 'Zippori', descriptionHe: 'פסיפסים מרהיבים בעיר העתיקה', descriptionEn: 'Stunning mosaics in ancient city', imageUrl: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=600&q=80&fit=crop' },
  { key: 'megiddo', nameHe: 'מגידו', nameEn: 'Megiddo', descriptionHe: 'תל עתיק - הארמגדון', descriptionEn: 'Ancient tel - Armageddon', imageUrl: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=80&fit=crop' },
