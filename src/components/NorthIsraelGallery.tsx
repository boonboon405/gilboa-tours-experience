...
const locations: Location[] = [
  ...
  { key: 'yardenit', nameHe: 'ירדנית', nameEn: 'Yardenit', descriptionHe: 'אתר הטבילה בנהר הירדן', descriptionEn: 'Jordan River baptism site', imageUrl: 'https://images.unsplash.com/photo-1760541726316-5c20875f8914?w=600&q=80&fit=crop' },
  { key: 'katzrin', nameHe: 'קצרין', nameEn: 'Katzrin', descriptionHe: 'בירת הגולן ופארק התלמוד', descriptionEn: 'Golan capital and Talmud park', imageUrl: 'https://images.unsplash.com/photo-1678134017317-4edd53da833d?w=600&q=80&fit=crop' },
  { key: 'jezreel-valley', nameHe: 'עמק יזרעאל', nameEn: 'Jezreel Valley', descriptionHe: 'העמק החקלאי הפורה', descriptionEn: 'Fertile agricultural valley', imageUrl: 'https://images.unsplash.com/photo-1608637765750-6b77adacfcac?w=600&q=80&fit=crop' },
  { key: 'nahal-snir', nameHe: 'נחל שניר', nameEn: 'Nahal Snir', descriptionHe: 'שמורת טבע עם מפלים ובריכות', descriptionEn: 'Nature reserve with pools', imageUrl: 'https://images.unsplash.com/photo-1593543321468-bbc5676c2f94?w=600&q=80&fit=crop' },
  { key: 'achziv', nameHe: 'אכזיב', nameEn: 'Achziv', descriptionHe: 'חוף ים קסום עם מפרצונים', descriptionEn: 'Magical beach with coves', imageUrl: 'https://images.unsplash.com/photo-1668678348012-b0fee6ef7677?w=600&q=80&fit=crop' },
  ...
  { key: 'bet-alfa', nameHe: 'בית אלפא', nameEn: 'Bet Alfa', descriptionHe: 'בית כנסת עתיק עם פסיפס גלגל המזלות', descriptionEn: 'Ancient zodiac mosaic synagogue', imageUrl: 'https://images.unsplash.com/photo-1769457661846-84ed4cb5971a?w=600&q=80&fit=crop' },
  ...
  { key: 'belvoir-fortress', nameHe: 'מבצר כוכב הירדן', nameEn: 'Belvoir Fortress', descriptionHe: 'מבצר צלבני עם נוף מרהיב', descriptionEn: 'Crusader fort with stunning views', imageUrl: 'https://images.unsplash.com/photo-1675305369968-2d614986608d?w=600&q=80&fit=crop' },
  { key: 'mount-meron', nameHe: 'הר מירון', nameEn: 'Mount Meron', descriptionHe: 'הפסגה הגבוהה ביותר בגליל', descriptionEn: 'Highest peak in Galilee', imageUrl: 'https://images.unsplash.com/photo-1697747245806-6aa4b6565a54?w=600&q=80&fit=crop' },
  ...
  { key: 'nahariya-beach', nameHe: 'חוף נהריה', nameEn: 'Nahariya Beach', descriptionHe: 'חוף ים תכלת במפרץ עכו', descriptionEn: 'Blue beach in Acre Bay', imageUrl: 'https://images.unsplash.com/photo-1469041635451-4512b21a9326?w=600&q=80&fit=crop' },
  ...
  { key: 'yehiam-fortress', nameHe: 'מבצר יחיעם', nameEn: 'Yehiam Fortress', descriptionHe: 'מבצר צלבני בגליל המערבי', descriptionEn: 'Crusader fort in Western Galilee', imageUrl: 'https://images.unsplash.com/photo-1552423313-b6b7ae492c4d?w=600&q=80&fit=crop' },
  { key: 'keshet-cave', nameHe: 'קשת מערה', nameEn: 'Keshet Cave', descriptionHe: 'קשת סלע טבעית מרהיבה', descriptionEn: 'Stunning natural rock arch', imageUrl: 'https://images.unsplash.com/photo-1541472544680-ccc2e0014462?w=600&q=80&fit=crop' },
  ...
  { key: 'nahal-kziv', nameHe: 'נחל כזיב', nameEn: 'Nahal Kziv', descriptionHe: 'שביל מים מרהיב בגליל', descriptionEn: 'Beautiful water trail in Galilee', imageUrl: 'https://images.unsplash.com/photo-1660924375739-75e64670bd40?w=600&q=80&fit=crop' },
