...
עכשיו ספרו לי - כמה אנשים? מה התקציב?`;
          ...
          greeting = `שלום! אני מומחה לסיוריים עם גישה לקטגוריות של חוויות:
🔥 הרפתקאות  |  💧 טבע  |  🏛️ היסטוריה  |  🍷 קולינריה  |  ⚡ ספורט  |  🎨 יצירה  |  🌿 בריאות  |  🤝 גיבוש צוות

100 אפשרויות ופעילויות שמחכות לכם! כדאי לעשות את ה ישנם -Quiz ענה על שאלות ה שאוכל להמליץ בדיוק על מה שמתאים לכם.
