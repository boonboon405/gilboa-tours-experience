...
const sections = [
  {
    ...
    images: [
      { src: heroImage, alt: 'תצפית פנורמית מפסגת הרי הגלבוע אל עמק המעיינות ועמק הירדן בשקיעה זהובה', title: 'רכס הגלבוע המרהיב' },
      { src: clubCarsImage, alt: 'רכבי שטח חשמליים מתמרנים בשבילי הגלבוע במהלך פעילות גיבוש צוותית אתגרית', title: 'אתגר רכבי שטח' },
      { src: pelicansImage, alt: 'להקת שקנאים ופלמינגו בנדידה עונתית מעל עמק הירדן בשבר הסורי אפריקאי', title: 'נדידת ציפורים' },
      { src: springsCombinedImage, alt: 'פעילויות מים ורכיבה על רכבים חשמליים במעיינות הטבעיים של עמק המעיינות', title: 'פעילויות בטבע' }
    ],
    activities: [
