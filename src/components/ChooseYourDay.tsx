...
const sections = [
  {
    ...
    activities: [
      "הליכת שביל מים נחל הקיבוצים (ראלי מכשולים צוותי)",
      "אתגר רכבי שטח דרך גבעות הגלבוע",
      "שיירת ג'יפים דרך עמק בית שאן",
      "ביקור בבית אהרון אהרונסון (רוכש אדמות יהודיות)",
      "חוויית כדור פורח בשחר מעל העמק ובריכות הדגים",
      "תחרות התמצאות ביער בית אלפא - צפייה בשקנאים",
      ...
      "טיול קצר לתצפית פסגת הגלבוע לשיחת הפתיחה והקפה"
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    activities: [
      ...
      "ביקור בגן הזיכרון לאסף שמיר ודובי שמיר - גולבוע",
      "חידון היסטוריה אינטראקטיבי: 'מי הלך כאן לפנינו?'",
      "עצירה בתצפית הר הגלבוע – הסיפור של הקרב האחרון של המלך שאול",
      "ביקור במוזיאון האמנות של קיבוץ עין חרוד (הפסקה יצירתית)",
      "מעגל סיפורים: 'משאול לעם הסטארטאפים – מנהיגות לאורך הדורות'",
      ...
      "ביקור בשרידים מתקופת התלמוד בתל רחב",
  ...
  },
  {
    ...
    activities: [
      "חוויה קולינרית: ארוחה עשירה במסעדה כשרה עם אוכל מזרחי אותנטי - בית שאן",
      "טעימת יין ביקב בוטיק מקומי (למשל, רמת שירין, עמק יזרעאל)",
      "סדנת שמן זית וטעימה",
      "תחרות בישול חיצונית 'אתגר מאסטר שף הצוות'",
      "'מסע טעמים בגליל' – טעימה עיוורת של מוצרים מקומיים",
      "אתגר בישול פויקה מסורתי (צוותים מתחרים)",
      "פינת בריבקיו בנה-אכול שלך ליד המים",
      "מזנון צהריים קיבוצי – תוצרת מקומית עונתית בניר דוד",
      "אתגר קינוחים צוותי עם תמרים, דבש ויוגורט מקומיים",
      "מפגש טעימת בירה מקומית",
      "ביקור בחוות תמרים – 'מהדקל לצלחת' - במושבה כנרת",
      "ביקור בחוות גבינות עיזים – טעימה והדגמת חליבה",
      "ארוחת פיקניק בדשאי מעיין חרוד",
      "תחרות יצירת בר מיצים",
      "תחרות צילום יום",
      "'יין וחוכמה' – דיון קבוצתי לא פורמלי על יין מקומי",
      "סדנת אפיית פיתה בתנורי טאבון",
      "שיעור הכנת חומוס אותנטי – אתגר קבוצתי",
      "בישול עם עשבי תיבול מגינות מקומיות",
      "'סיומים מתוקים' – שוקולד, חלווה או פירות מפסגת הגלבוע - תצפית נופית",
      "טקס טוסט צוותי – 'לחיים לשיתוף פעולה!' - בעין מגדל"
    ]
  }
];
