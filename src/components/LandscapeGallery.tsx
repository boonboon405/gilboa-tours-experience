...
const getStaticSections = (isHe: boolean): GallerySection[] => [
  {
    ...
    images: [
      ...
      { src: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=800&q=80&fit=crop', alt: isHe ? 'שרידי העיר הרומית סקיתופוליס בבית שאן' : 'Ruins of the Roman city Scythopolis in Beit She\'an', title: isHe ? 'עמק בית שאן' : 'Beit She\'an Valley', description: isHe ? 'נוף היסטורי מרהיב' : 'Stunning historical landscape' },
      { src: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=800&q=80&fit=crop', alt: isHe ? 'פנורמה של התיאטרון הרומי העתיק בבית שאן' : 'Panorama of the ancient Roman theater in Beit She\'an', title: isHe ? 'התיאטרון הרומי' : 'The Roman Theater', description: isHe ? 'מבט פנורמי על העתיקות' : 'Panoramic view of the antiquities' },
  ...
  },
  {
    ...
    images: [
      { src: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&q=80&fit=crop', alt: isHe ? 'תצפית מפסגת הרי הגלבוע' : 'View from the summit of Mount Gilboa', title: isHe ? 'הרי הגלבוע' : 'Mount Gilboa', description: isHe ? 'שקיעה מדהימה מפסגות הגלבוע' : 'Stunning sunset from the Gilboa peaks' },
      ...
      { src: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=800&q=80&fit=crop', alt: isHe ? 'נוף עמק בית שאן מהגלבוע' : 'Beit She\'an Valley view from Gilboa', title: isHe ? 'תצפית העמק' : 'Valley Lookout', description: isHe ? 'מבט לעמק מהפסגה' : 'View of the valley from the summit' },
